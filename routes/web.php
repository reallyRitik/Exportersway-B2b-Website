...
Route::get('/addtofav/{lead_id}', [LeadlistController::class, 'favenquiryadd'])
    ...
    Route::post('/submit-Enquiry', [CustomerController::class, 'sendenquiry'])->name('submit.Enquiry');
Route::post('/decrement-points', [LeadlistController::class, 'decrementPoints'])->name("decrement.points");
Route::post('/submit-inquiry', [LeadlistController::class, 'submitInquiry'])->name('submit.inquiry');
Route::get('/leaddetail/{id}', [LeadlistController::class, 'showLeadDetails'])->name('leaddetail');
Route::get('reload-captcha', [LeadlistController::class, 'reloadCaptcha'])->name('reloadCaptcha');
