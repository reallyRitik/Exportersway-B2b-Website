    ...
    <div class="row comp_info flex-row mt-20" style="margin-bottom:20px; width:100%">
        ...
        <div class="mb-20  col-12 col-sm-12 col-md-6 ">
            <div class="co-specification-container">
                ...
                <div class="row" style="width:100;">
                    <form method="POST" action="{{ route('submit.Enquiry') }}" id="inquiry_form2">
                        @csrf
                        <div class="col-12">
                            <div class="form-group">
                                <input class="form-control" placeholder="Name" name="fname" type="text" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input class="form-control" placeholder="Company name" name="companyname" value="{{$data->company_name}}" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <!-- Fixed the name attribute from 'massage' to 'message' -->
                                <textarea class="form-control" placeholder="Message" name="message" cols="50" rows="10" required></textarea>
                            </div>
                        </div>
                        <div class="col-12">
