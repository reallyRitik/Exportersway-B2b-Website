...
<body>
    ...
    $leadToken = \App\Models\Leadtoken::where('user_id', Auth::id())->where('lead_id', $lead->id)->first();
@endphp
@if($leadToken)
...
@endif
    ...
    <div class="col-12 col-xs-12">
        <div class="form-group">
            <textarea name="message" rows="3" cols="43" placeholder="Message" required>Message</textarea>
        </div>
    </div>
...
@endif
    ...
    $.ajax({
        ...
        success: function(response) {
            $('.captcha-box strong').html(response.captcha);
        }
    });
}
