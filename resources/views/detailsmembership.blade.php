...
<head>
     <meta charset="utf-8">
        ...
        <title>Tetra Package: Premium Brand-Building Services - ExpotersWay</title>
        <meta name="keywords" content="tetra package, brand-building services, seo-friendly website, premium brand marketing, verified business leads, online and offline marketing, comprehensive brand services, international business exposure, affordable brand development, business enquiry package"/>
        <meta name="google-site-verification" content="AyO2_SgJ7H1RYH8StqldojMzYEgxcLeS30SQIwXvqls" />
        <meta name="description" content="Boost your brand with Tetra Package: comprehensive online and offline marketing, SEO-friendly website, verified leads, and more. Domestic: Rs. 11,999+GST, International: $249.">
...
<body>
            ...
            <div class="row" style="width: 100%;">
                <div class="col-md-6 col-12 col-sm-6 col-lg-6">
                    <div class="vip-exps">
                        ...
                        <h2>Tetra Package</h2>
                        <p>Enjoy the benefits of premium brand-building and boost the potential of your business in a cost-effective manner. Our unique Tetra Package offers all the essential services you need for brand creation and enrichment. With a focus on both online and offline marketing, this package provides you with a comprehensive international exposure to maximize your brand's reach and impact.</p>
                        <h5 style="color:#ffc706">
                    <br>For Domestic :- <b>Rs. 11, 999/- +GST</b>
                    <br>For International :- <b>$249</b></h5> 
                    </div>

                    
                    <br>
                    <ul class="vip-exps-list aos-init ">
                        <li>Number Of Website Page (2 pages)</li>
                        <li>Hosting+Maintenance</li>
                        <li>Verified Buy Lead (2/month)</li>
                        <li>Product Display Ranking (Above free member)</li>
                        <li>Unlimited Business Enquiry</li>
                        <li>Max Listing (50)</li>
                        <li>Google Seo Friendly Website</li>
                        <li>Product Display In Website (10)</li>
    ...
    height: 30px;}</style>
                    <ul class="vip-exps-list-btn aos-init ">
                        <li>
                            <a target="_blank" href="{{ asset('pdf/TETRA BUSINESS USD.pdf')}}">View Brochure</a>
                        </li>
                        <li>
