                        ...
                        <form action="{{ route('searchLead') }}" method="GET">
                            <div class="search-fields-cont">
                                <div class="search-col2">
                                    <input name="title" class="form-control" type="text" placeholder="search lead you are looking? " value="{{ request('title') }}" style="border: 1px solid #BE9939 !important;
                    ...
                    <div class="row" style="width: 100%;">
                        <div class="reg-form form-container">
                            <form mathod="" action="">
                                ...
                                <div class="col-12 col-xs-12 padr4">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Message* " required name="massage" type="text">
                                    </div>
                                </div>
                                <div class="col-xs-12">
...
@php
    // Check if the lead is already favorited and retrieve the Leadtoken record
    $leadToken = \App\Models\Leadtoken::where('user_id', Auth::id())->where('lead_id', $row->id)->first();
@endphp

@if($leadToken)
    <!-- If the lead is already favorited, show the actual created_at date from the Leadtoken model -->
    <h4 style="color:green;">
         Inquiry sent successfully on {{ $leadToken->created_at->format('Y-m-d') }}
    </h4>
@else
    <!-- If the lead is not favorited, show Add to favorite link -->
