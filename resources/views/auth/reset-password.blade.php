...
<meta charset="utf-8">
        ...
        <title>Exporters Way - Exporters and Suppliers in India</title>
...
<body>
	...
	<div class="container">
      ...
      <img id="headerLogo" src="{{ asset('companylogo/logo.png')}}" alt="Exportersway">
      <br><br>
				<!-- <h2 class="title">Welcome</h2> -->
           		<div class="input-div one">
           		   ...
           		   <div class="div">
           		   		...
           		   		<input  id="email" class="block mt-1 w-full input validate" type="email" name="email" :value="old('email', $request->email)" required autofocus class="input100{{ $errors->has('email') ? ' is-invalid' : '' }}" >
                   ...
                   <div class="input-div pass">
           		   ...
           		   <div class="div">
                      <h5>Enter confirm Password</h5>
           		   		<input  id="password_confirmation" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password">
						   <i id="togglePassword" class="password-toggle">👁️</i>
            	   </div>
            	</div>
              <button type='submit' name='btn_login' class='col s12 btn btn-large waves-effect indigo'>{{ __('Reset Password') }}</button>
              <script>
