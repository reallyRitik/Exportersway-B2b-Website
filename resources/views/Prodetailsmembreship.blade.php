...
<head>
     <meta charset="utf-8">
        ...
        <title>Pro Package: Premium Brand-Building Services - ExportersWay</title>
        <meta name="keywords" content="pro package, brand-building, seo website, business leads, online marketing, offline marketing, international brand, brand services, business enquiry, affordable branding"/>
        <meta name="google-site-verification" content="AyO2_SgJ7H1RYH8StqldojMzYEgxcLeS30SQIwXvqls" />
        <meta name="description" content="Maximize your brand's potential with the Pro Package: extensive marketing, SEO-friendly website, verified leads, and more. Domestic: Rs. 39,999+GST, International: $999">
...
<body>
            ...
            <div class="row" style="width: 100%;">
                <div class="col-md-6 col-12 col-sm-6 col-lg-6">
                    ...
                    <ul class="vip-exps-list aos-init ">
                        ...
                        <li>Number Of Website Page (25 pages)</li>
                        <li>Customize Home Page</li>
                        <li>SSL Certificate</li>
                        <li>Domain</li>
                        <li>Hosting+Maintenance</li>
                        <li>Mobile Responsive Website</li>
                        <li>Product And Services Display (50)</li>
                        <li>Verified Buy Lead (12/Month)</li>
                          
                        <li>Import Export Consultant</li>
                        <li>Dedicated B2B  (1)</li>
                         <li>Logo designing</li>
                          <li>Social Media Profile Handling</li>
                        <li>Dedicated Account Manager</li>
                        <li>Corporate Video (Yes UPTO 25MB)</li>
                        <li>Product Display Ranking (Above Growing members)</li>
                        <li>Unlimited Business Enquiry</li>
                        <li>Max Listing (150)</li>
                        <li>Water Mark</li>
    ...
    height: 30px;}</style>
                    <ul class="vip-exps-list-btn aos-init ">
                        <li>
                            <a target="_blank" href="{{ asset('pdf/PRO BUSINESS USD.pdf')}}">View Brochure</a>
                        </li>
                        <li>
