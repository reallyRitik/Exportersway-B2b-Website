                ...
                <table class="table table-responsive">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-top:0;">  <a href="#" onclick="showSweetAlert()">SHOW</a></td>
                        </tr>
                        <tr>
            ...
            <div class="co-specification-container">
                ...
                <div class="row" style="width:100;">
                    <form mathod="post" id="inquiry_form2">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Message" name="massage" type="text" cols="50" rows="10" required></textarea>
                            </div>
