...
<head>
     <meta charset="utf-8">
        ...
        <title>Growing Package: Comprehensive Brand-Building Services</title>
        <meta name="keywords" content="growing package, brand-building services, seo-friendly website,
            premium brand marketing, verified business leads, online and offline marketing, international business exposure, comprehensive brand services, business enquiry package, affordable brand development"/>
        <meta name="google-site-verification" content="AyO2_SgJ7H1RYH8StqldojMzYEgxcLeS30SQIwXvqls" />
        <meta name="description" content="Enhance your brand with the Growing Package: extensive online and offline marketing, SEO-friendly website, verified leads, and more. Domestic: Rs. 21,999+GST, International: $499">
...
<body>
            ...
            <div class="row" style="width: 100%;">
                <div class="col-md-6 col-12 col-sm-6 col-lg-6">
                    <div class="vip-exps">
                        ...
                        <h2>Growing Package</h2>
                        <p>Experience the benefits of premium brand-building and effectively enhance the potential of your business. Our unique Growing Package provides all the essential services necessary for brand creation and enrichment. Whether it's online and digital marketing or offline marketing, this package offers a comprehensive range of services that give your brand complete international exposure.</p>
                        <h5 style="color:#ffc706">
                    <br>For Domestic :- <b>Rs. 21, 999/- +GST</b>
                    <br>For International :- <b>$499</b></h5> 
                    ...
                    <ul class="vip-exps-list aos-init ">
                        ...
                        <li>Number Of Website Page (10 pages)</li>
                        <li>Customize Home Page</li>
                        <li>Domain</li>
                        <li>Hosting+Maintenance</li>
                        <li>Mobile Responsive Website</li>
                        <li>Product Display In Website (25)</li>
                        <li>Dedicated Account Manager</li>
                        <li>Product Display Ranking (Above Tetra member)</li>
                        <li>Verified Buy Lead (4/month)</li>
                        <li>Unlimited Business Enquiry</li>
                        <li>Max Listing (125)</li>
    ...
    height: 30px;}</style>
                    <ul class="vip-exps-list-btn aos-init ">
                        <li>
                            <a target="_blank" href="{{ asset('pdf/GROWING BUSINESS USD.pdf')}}">View Brochure</a>
                        </li>
                        <li>
