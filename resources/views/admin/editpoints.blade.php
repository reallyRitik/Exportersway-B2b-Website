		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Point</div>
					<div class="ps-3">
...
@endif
    ...
    setTimeout(function() {
        $('#session-message1').remove();
							...
							<div class="card-body">
                            <form action="{{ url('savepoints',['id' => $listcust->id]) }}"  method="post"  >
                                                           @csrf
								<!-- Repeater Content -->
								<div class="item-content">
                                    ...
                                    <div class="mb-3">
                          <label for="simpleinput" class="form-label">Points</label>         
<input type="number"id="simpleinput" class="form-control"  name="points" value="{{$listcust->points}}">
