                        ...
                        <div class="bo-attr-left">
                            <ul class="bo-leftattr">
                                ...
                                <li>
                                    ...
                                    &nbsp;
                                    <a  href="index.html" style="color: #ff6701;" >{{$lead->mobile}}</a>
                                </li>
                                <!-- <li>
                                    <span>
                                        Company Name
                                    </span>
                                    Francisco Jose Arias
                                </li> -->
                                <li>
                                    <span>
                                       Posted
...
<a class="btn btn-red btn-contact btn-contact-main "style="margin-top: 15px;" title="Contact Buyer" href="{{url('login')}}">
Contact Buyer
</a>
<a  href="{{route('lead_data')}}" class="btn btn-blue btn-contact btn-contact-main" style="margin-top: 15px;" title="Contact Buyer">
Your Requirement
</a>
            </div>
        </div>
