...
<head>
     <meta charset="utf-8">
        ...
        <title>Gold Advance Package: Premium Brand-Building Services</title>
        <meta name="keywords" content="gold package,brand-building, seo website, business leads, online marketing, offline marketing, international brand, brand services, business enquiry, affordable branding"/>
        <meta name="google-site-verification" content="AyO2_SgJ7H1RYH8StqldojMzYEgxcLeS30SQIwXvqls" />
        <meta name="description" content="Boost your business with the Gold Advance Package: complete marketing services, SEO-friendly website, verified leads, and more. Domestic: Rs. 79,999+GST, International: $1499">
...
<body>
        ...
        <div class="container">
            <div class="row" style="width: 100%;">
                <div class="col-md-6 col-12 col-sm-6 col-lg-6">
                    <div class="vip-exps">
                        <h3>Be a part of The</h3>
                        <h2>advance Experience</h2>
                        <p>Enjoy premium brand-building and boost the potential of your business cost-effectively. Get all the must-needed services for brand creation and enrichment with our unique gold advance package. From online & digital marketing to offline marketing, this package gives you a zest of complete international exposure.</p>
                        <h5 style="color:#ffc706">
                    <br>For Domestic :- <b>Rs. 79, 999/- +GST</b>
                    <br>For International :- <b>$1499</b></h5> 
                    
                    </div>
                    
                    <br>
                    <ul class="vip-exps-list aos-init ">
                          <li>Google Seo Friendly Website</li>
                        <li>Number Of Website Page (50 pages)</li>
                        <li>Customize Home Page</li>
                        <li>Website Backend Control</li>
                        <li>Domain</li>
                        <li>Hosting+Maintenance</li>
                        <li>Mobile Responsive Website</li>
                         <li>SSL Certificate</li>
                        <li>Product And Services Display (75)</li>
                        <li>Dedicated Account Manager</li>
                        <li>Product Display Ranking (Above PRO member)</li>
                        <li>Verified Buy Lead (25/Month)</li>
                          <li>Import Export Consultant</li>
                                   <li>International Language Support (4 Language)	</li>
                        <li>Unlimited Business Enquiry</li>
                          <li>SMO</li>
                          <li>Dedicated B2B (2)</li>
                          <li>Logo designing</li>
                           <li>Pop Mail Id (2)</li>
                        <li>Flip Book (4 Pages)</li>
                        
                        <li>Social Media Profile Handling</li>
                        <li>Corporate Video (UPTO 50 MB)</li>
                         <li>Company YouTube Channel & Linking</li>
                        <li>Max Listing (200)</li>
                         <li>Water Mark</li>
                         <li>Product Designing (2D)</li>
                   
                    </ul>
                    <ul class="deatilsmembre aos-init ">
    ...
    width: 30px;
    height: 30px;}</style>
                    <ul class="vip-exps-list-btn aos-init ">
                        <li>
                            <a target="_blank" href="{{ asset('pdf/Elite  Business usd.pdf')}}">View Brochure</a>
                        </li>
                        <li>
                           <a target="_blank" href="https://payment.exportersway.com/" style="    color: #fff;
    border-color: #336699;
    background-color: #336699;">
              Purchase Package
                ...
                <div class="col-md-5 col-12 col-sm-5 col-lg-5">
              
  <form id="contact" action="" method="post">
    <h3> Get Connected With Global</h3>
    <h4> Buyers and Sellers</h4>
    <p>Sign up now and expand your business with us!</p>
    <fieldset>
...
<select id="cars">
  ...
  <option value="Elite Plus">Elite Plus</option>
    ...
    <fieldset>
      <input  type="checkbox" required> I agree to <a>Terms and Conditions <span>*</span></a>
    </fieldset>
    <fieldset>
...
:-ms-input-placeholder {
 color:#888;
        ...
        ul.vip-exps-list li:before {
            content: url("{{ asset('pricelogo/a.png')}}");
            position: absolute;
            left: 0;
            top: 0;
            width: 30px;
        ...
        div.tetrapage {
            ...
            background: url("{{ asset('pricelogo/1.jpeg')}}");
