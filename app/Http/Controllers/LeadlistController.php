...
public function submitInquiry(Request $request)
{
  ...
  foreach ($favoriteLeads as $favoriteLead) {
    ...
    $message .= '
        ...
        <div class="terms">
            <p>
        Exportersway.com is an enhanced web-based platform meant for the development and enhancement of all categories of businesses. This is done in two ways: 
        by searching for suitable companies and then interacting with them. Exportersway.com is the owner of the website. 
        The use of the website, in part or complete, is subject to the acceptance of the website\'s terms and conditions. 
        Everyone willing to use the website services should agree to the terms and conditions mentioned below. 
        Only those companies, firms, or individuals who are eligible to create binding contracts that are legal under Indian laws can use the services. 
        Exportersway.com reserves the right to amend these terms and conditions before publishing them on the site. 
        Once they are published on the site, they will be deemed approved and effective from the date posted.
    </p>
    <br>
    <h6>Click the link below to visit our website:</h6>
    <br>
    <a href="https://exportersway.com/">Exportersway.com</a>
        </div>
    </body>
    </html>';
...
public function showLeadDetails(Request $request, $id)
{
    ...
    if (!$user) {
        return response()->json([
            ...
            'redirect' => route('login') // Adjust this route as necessary
        ]);
    }
